...
public class ApiController {
	...
	/*@GetMapping(value="/monthly", produces = "application/json; charset=utf8")
	@ResponseBody
	public List<CovidStatus> monthData() {
		
		List<CovidStatus> covidStatusMonthData = restService.getMonthData();
	}*/
