			...
			<div class="row sm-12 content" id="target">
				...
				<div class="seoul-info-box">
					<button class="btn btn-light active" type="button">
						<span class="location-info-title">서울</span><br>
						<span id="seoulCount" class="location-info-count"></span><br>
						<div id="seoul" class="location-info-def">
							<span id ="seoulDef"></span>
						</div>
					</button>
				</div>
				<div class="incheon-info-box">
					<button class="btn btn-light" type="button">
						<span class="location-info-title">인천</span><br>
						<span id="incheonCount" class="location-info-count"></span><br>
						<div id="incheon" class="location-info-def">
							<span id ="incheonDef"></span>
						</div>
					</button>
				</div>
				
				<div class="gyeongi-info-box">
					<button class="btn btn-light" type="button">
						<span class="location-info-title">경기</span><br>
						<span id="gyeongiCount" class="location-info-count"></span><br>
						<div id="gyeongi" class="location-info-def">
							<span id ="gyeongiDef"></span>
						</div>
					</button>
				</div>
					
				<div class="gangwon-info-box">
					<button class="btn btn-light" type="button">
						<span class="location-info-title">강원</span><br>
						<span id="gangwonCount" class="location-info-count"></span><br>
						<div id="gangwon" class="location-info-def">
							<span id ="gangwonDef"></span>
						</div>
					</button>
				</div>
				
				<div class="chungbuk-info-box">
					<button class="btn btn-light" type="button">
						<span class="location-info-title">충북</span><br>
						<span id="chungbukCount" class="location-info-count"></span><br>
						<div id="chungbuk" class="location-info-def">
							<span id ="chungbukDef"></span>
						</div>
					</button>
				</div>
				
				<div class="chungnam-info-box">
					<button class="btn btn-light" type="button">
						<span class="location-info-title">충남</span><br>
						<span id="chungnamCount" class="location-info-count"></span><br>
						<div id="chungnam" class="location-info-def">
							<span id ="chungnamDef"></span>
						</div>
					</button>
				</div>
				
				<div class="sejong-info-box">
					<button class="btn btn-light" type="button">
						<span class="location-info-title">세종</span><br>
						<span id="sejongCount" class="location-info-count"></span><br>
						<div id="sejong" class="location-info-def">
							<span id ="sejongDef"></span>
						</div>
					</button>
				</div>
				
				<div class="gyeongbuk-info-box">
					<button class="btn btn-light" type="button">
						<span class="location-info-title">경북</span><br>
						<span id="gyeongbukCount" class="location-info-count"></span><br>
						<div id="gyeongbuk" class="location-info-def">
							<span id ="gyeongbukDef"></span>
						</div>
					</button>
				</div> 
				
				<div class="jeonbuk-info-box">
					<button class="btn btn-light" type="button">
						<span class="location-info-title">전북</span><br>
						<span id="jeonbukCount" class="location-info-count"></span><br>
						<div id="jeonbuk" class="location-info-def">
							<span id ="jeonbukDef"></span>
						</div>
					</button>
				</div>
				
				<div class="daejeon-info-box">
					<button class="btn btn-light" type="button">
						<span class="location-info-title">대전</span><br>
						<span id="daejeonCount" class="location-info-count"></span><br>
						<div id="daejeon" class="location-info-def">
							<span id ="daejeonDef"></span>
						</div>
					</button>
				</div>
				
				<div class="daegu-info-box">
					<button class="btn btn-light" type="button">
						<span class="location-info-title">대구</span><br>
						<span id="daeguCount" class="location-info-count"></span><br>
						<div id="daegu" class="location-info-def">
							<span id ="daeguDef" ></span>
						</div>
					</button>
				</div>
				
				<div class="ulsan-info-box">
					<button class="btn btn-light" type="button">
						<span class="location-info-title">울산</span><br>
						<span id="ulsanCount" class="location-info-count"></span><br>
						<div id="ulsan" class="location-info-def">
							<span id ="ulsanDef"></span>
						</div>
					</button>
				</div>
				
				<div class="busan-info-box">
					<button class="btn btn-light" type="button">
						<span class="location-info-title">부산</span><br>
						<span id="busanCount" class="location-info-count"></span><br>
						<div id="busan" class="location-info-def">
							<span id ="busanDef" ></span>
						</div>
					</button>
				</div>
				
				<div class="gwangju-info-box">
					<button class="btn btn-light" type="button">
						<span class="location-info-title">광주</span><br>
						<span id="gwangjuCount" class="location-info-count"></span><br>
						<div id="gwangju" class="location-info-def">
							<span id ="gwangjuDef" ></span>
						</div>
					</button>
				</div>
				
				<div class="jeonnam-info-box">
					<button class="btn btn-light" type="button">
						<span class="location-info-title">전남</span><br>
						<span id="jeonnamCount" class="location-info-count"></span><br>
						<div id="jeonnam" class="location-info-def">
							<span id ="jeonnamDef" ></span>
						</div>
					</button>
				</div>				
				
				<div class="gyeongnam-info-box">
					<button class="btn btn-light" type="button">
						<span class="location-info-title">경남</span><br>
						<span id="gyeongnamCount" class="location-info-count"></span><br>
						<div id="gyeongnam" class="location-info-def">
							<span id ="gyeongnamDef"></span>
						</div>
					</button>
				</div>
				
				<div class="jeju-info-box">
					<button class="btn btn-light" type="button">
						<span class="location-info-title">제주</span><br>
						<span id="jejuCount" class="location-info-count"></span><br>
						<div id="jeju" class="location-info-def">
							<span id ="jejuDef" ></span>
						</div>
					</button>
				</div>
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:amcharts="http://amcharts.com/ammap" xmlns:xlink="http://www.w3.org/1999/xlink"  version="1.1" height="850" width="500">
	<defs>
		<style type="text/css">
			.land
			{
	...
	<g>
		...
		<path id="KR-50" title="Sejong" class="land" d="M180.84,395.146L182.397,397.326L182.086,400.128L179.906,400.751L182.709,404.176L182.709,406.979L183.159,408.328L186.491,408.523L186.398,409.979L185.573,411.799L186.651,412.939L184.789,419.024L185.367,418.243L185.766,417.918L186.472,418.063L187.087,418.922L187.396,418.957L187.068,422.235L186.134,425.039L182.709,426.596L181.798,426.639L179.283,427.218L179.596,435.937L177.416,438.428L175.713,436.376L173.965,435.031L172.754,431.937L172.888,427.902L172.619,425.077L171.274,421.176L168.583,419.697L166.7,417.141L166.566,415.123L167.642,412.702L167.642,409.608L167.507,406.11L167.239,402.747L167.911,400.326L167.642,397.231L167.104,395.215L166.028,393.197L166.431,391.447L169.122,390.371L171.677,391.178L173.157,392.793L175.848,394.407L178.403,395.348z"/>
			...
			<!-- <text style="font-size: 24px;">
    			<textPath xlink:href="#KR-11">서울</textPath>
 			 </text> -->
	</g>
...
<script>
	...
	//seoul.css('top',282)
	//seoul.css('left',(a.position().left-target.position().left)/4)
	//target.css("top",target)
...
$(document).ready(function() {
	...
	$.ajax({
		...
		success : function(data) {
			...
			var today = new Date();
			 var seoultodayData;
	         var seoulyesterDayData;
	         var busantodayData;
	         var busanyesterDayData;
	         var daegutodayData;
	         var daeguyesterDayData;
	         var incheontodayData;
	         var incheonyesterDayData;
	         var gwangjutodayData;
	         var gwangjuyesterDayData;
	         var daejeontodayData;
	         var daejeonyesterDayData;
	         var ulsantodayData;
	         var ulsanyesterDayData;
	         var sejongtodayData;
	         var sejongyesterDayData;
	         var gyeongitodayData;
	         var gyeongiyesterDayData;
	         var gangwontodayData;
	         var gangwonyesterDayData;
	         var chungbuktodayData;
	         var chungbukyesterDayData;
	         var chungnamtodayData;
	         var chungnamyesterDayData;
	         var jeonbuktodayData;
	         var jeonbukyesterDayData;
	         var jeonnamtodayData;
	         var jeonnamyesterDayData;
	         var gyeongbuktodayData;
	         var gyeongbukyesterDayData;
	         var gyeongnamtodayData;
	         var gyeongnamyesterDayData;
	         var jejutodayData;
	         var jejuyesterDayData;
			...
			for (var i = 0; i < data.length; i++) {
				...
				if (data[i].gubun == '서울') {
					if (changeC == moment(today).format('YYYY-MM-DD')) {
						$('#seoulCount').text(data[i].incDec).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
						seoultodayData = data[i].incDec;

					}
					else {
						seoulyesterDayData = data[i].incDec;
					}
					
					if(seoultodayData-seoulyesterDayData<0) {
						$('#seoul').prepend("<i class='fas fa-chevron-down'></i>");
						$('#seoulDef').text(Math.abs(seoultodayData-seoulyesterDayData)).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");	
					}
					else if(seoultodayData-seoulyesterDayData>0) {
						$('#seoul').prepend("<i class='fas fa-chevron-up'></i>");
						$('#seoulDef').text(seoultodayData-seoulyesterDayData).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						$('#seoulDef').text(seoultodayData-seoulyesterDayData).toString().replace(
				...
				} else if (data[i].gubun == '부산') {
					if (changeC == moment(today).format('YYYY-MM-DD')) {
						$('#busanCount').text(data[i].incDec).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
						busantodayData = data[i].incDec;
					}
					else {
						busanyesterDayData = data[i].incDec;
					}
					
					if(busantodayData-busanyesterDayData<0) {
						$('#busan').prepend("<i class='fas fa-chevron-down'></i>");
						$('#busanDef').text(Math.abs(busantodayData-busanyesterDayData)).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");	
					}
					else if(busantodayData-busanyesterDayData>0) {
						$('#busan').prepend("<i class='fas fa-chevron-up'></i>");
						$('#busanDef').text(busantodayData-busanyesterDayData).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						$('#busanDef').text(busantodayData-busanyesterDayData).toString().replace(
				...
				else if (data[i].gubun == '대구') {
					if (changeC == moment(today).format('YYYY-MM-DD')) {
						$('#daeguCount').text(data[i].incDec).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
						daegutodayData = data[i].incDec;

					}
					else {
						daeguyesterDayData = data[i].incDec;
					}
					
					if(daegutodayData-daeguyesterDayData<0) {
						$('#daegu').prepend("<i class='fas fa-chevron-down'></i>");
						$('#daeguDef').text(Math.abs(daegutodayData-daeguyesterDayData)).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");	
					}
					else if(daegutodayData-daeguyesterDayData>0) {
						$('#daegu').prepend("<i class='fas fa-chevron-up'></i>");
						$('#daeguDef').text(daegutodayData-daeguyesterDayData).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						$('#daeguDef').text(daegutodayData-daeguyesterDayData).toString().replace(
				...
				else if (data[i].gubun == '인천') {
					if (changeC == moment(today).format('YYYY-MM-DD')) {
						$('#incheonCount').text(data[i].incDec).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
						incheontodayData = data[i].incDec;
	
					}
					else {
						incheonyesterDayData = data[i].incDec;
					}
					
					if(incheontodayData-incheonyesterDayData<0) {
						$('#incheon').prepend("<i class='fas fa-chevron-down'></i>");
						$('#incheonDef').text(Math.abs(incheontodayData-incheonyesterDayData)).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");	
					}
					else if(incheontodayData-incheonyesterDayData>0) {
						$('#incheon').prepend("<i class='fas fa-chevron-up'></i>");
						$('#incheonDef').text(incheontodayData-incheonyesterDayData).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						$('#incheonDef').text(incheontodayData-incheonyesterDayData).toString().replace(
				...
				else if (data[i].gubun == '광주') {
					if (changeC == moment(today).format('YYYY-MM-DD')) {

						$('#gwangjuCount').text(data[i].incDec).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
						gwangjutodayData = data[i].incDec;
					}
					else {
						gwangjuyesterDayData = data[i].incDec;
					}
					
					if(gwangjutodayData-gwangjuyesterDayData<0) {
						$('#gwangju').prepend("<i class='fas fa-chevron-down'></i>");
						$('#gwangjuDef').text(Math.abs(gwangjutodayData-gwangjuyesterDayData)).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");	
					}
					else if(gwangjutodayData-gwangjuyesterDayData>0) {
						$('#gwangju').prepend("<i class='fas fa-chevron-up'></i>");
						$('#gwangjuDef').text(gwangjutodayData-gwangjuyesterDayData).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						$('#gwangjuDef').text(gwangjutodayData-gwangjuyesterDayData).toString().replace(
				...
				else if (data[i].gubun == '대전') {
					if (changeC == moment(today).format('YYYY-MM-DD')) {

						$('#daejeonCount').text(data[i].incDec).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
						daejeontodayData = data[i].incDec;
					}
					else {
						daejeonyesterDayData = data[i].incDec;
					}
					
					if(daejeontodayData-daejeonyesterDayData<0) {
						$('#daejeon').prepend("<i class='fas fa-chevron-down'></i>");
						$('#daejeonDef').text(Math.abs(daejeontodayData-daejeonyesterDayData)).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");	
					}
					else if(daejeontodayData-daejeonyesterDayData>0) {
						$('#daejeon').prepend("<i class='fas fa-chevron-up'></i>");
						$('#daejeonDef').text(daejeontodayData-daejeonyesterDayData).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						$('#daejeonDef').text(daejeontodayData-daejeonyesterDayData).toString().replace(
				...
				else if (data[i].gubun == '울산') {
					if (changeC == moment(today).format('YYYY-MM-DD')) {
						ulsantodayData = data[i].incDec;
						$('#ulsanCount').text(data[i].incDec).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						ulsanyesterDayData = data[i].incDec;
					}
					
					if(ulsantodayData-ulsanyesterDayData<0) {
						$('#ulsan').prepend("<i class='fas fa-chevron-down'></i>");
						$('#ulsanDef').text(Math.abs(ulsantodayData-ulsanyesterDayData)).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");	
					}
					else if(ulsantodayData-ulsanyesterDayData>0) {
						$('#ulsan').prepend("<i class='fas fa-chevron-up'></i>");
						$('#ulsanDef').text(ulsantodayData-ulsanyesterDayData).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						$('#ulsanDef').text(ulsantodayData-ulsanyesterDayData).toString().replace(
				...
				else if (data[i].gubun == '세종') {
					if (changeC == moment(today).format('YYYY-MM-DD')) {
						sejongtodayData = data[i].incDec;
						$('#sejongCount').text(data[i].incDec).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						sejongyesterDayData = data[i].incDec;
					}
					
					if(sejongtodayData-sejongyesterDayData<0) {
						$('#sejong').prepend("<i class='fas fa-chevron-down'></i>");
						$('#sejongDef').text(Math.abs(sejongtodayData-sejongyesterDayData)).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");	
					}
					else if(sejongtodayData-sejongyesterDayData>0) {
						$('#sejong').prepend("<i class='fas fa-chevron-up'></i>");
						$('#sejongDef').text(sejongtodayData-sejongyesterDayData).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						$('#sejongDef').text(sejongtodayData-sejongyesterDayData).toString().replace(
				...
				else if (data[i].gubun == '경기') {
					if (changeC == moment(today).format('YYYY-MM-DD')) {
						gyeongitodayData = data[i].incDec;

						$('#gyeongiCount').text(data[i].incDec).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						gyeongiyesterDayData = data[i].incDec;
					}
					
					if(gyeongitodayData-gyeongiyesterDayData<0) {
						$('#gyeongi').prepend("<i class='fas fa-chevron-down'></i>");
						$('#gyeongiDef').text(Math.abs(gyeongitodayData-gyeongiyesterDayData)).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");	
					}
					else if(gyeongitodayData-gyeongiyesterDayData>0) {
						$('#gyeongi').prepend("<i class='fas fa-chevron-up'></i>");
						$('#gyeongiDef').text(gyeongitodayData-gyeongiyesterDayData).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						$('#gyeongjiDef').text(gyeongitodayData-gyeongiyesterDayData).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
				}

				else if (data[i].gubun == '강원') {
					if (changeC == moment(today).format('YYYY-MM-DD')) {
						gangwontodayData = data[i].incDec;
						$('#gangwonCount').text(data[i].incDec).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						gangwonyesterDayData = data[i].incDec;
					}
					
					if(gangwontodayData-gangwonyesterDayData<0) {
						$('#gangwon').prepend("<i class='fas fa-chevron-down'></i>");
						$('#gangwonDef').text(Math.abs(gangwontodayData-gangwonyesterDayData)).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");	
					}
					else if(gangwontodayData-gangwonyesterDayData>0) {
						$('#gangwon').prepend("<i class='fas fa-chevron-up'></i>");
						$('#gangwonDef').text(gangwontodayData-gangwonyesterDayData).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						$('#gangwonDef').text(gangwontodayData-gangwonyesterDayData).toString().replace(
				...
				else if (data[i].gubun == '충북') {
					if (changeC == moment(today).format('YYYY-MM-DD')) {
						chungbuktodayData = data[i].incDec;
						$('#chungbukCount').text(data[i].incDec).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						chungbukyesterDayData = data[i].incDec;
					}
					
					if(chungbuktodayData-chungbukyesterDayData<0) {
						$('#chungbuk').prepend("<i class='fas fa-chevron-down'></i>");
						$('#chungbukDef').text(Math.abs(chungbuktodayData-chungbukyesterDayData)).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");	
					}
					else if(chungbuktodayData-chungbukyesterDayData>0) {
						$('#chungbuk').prepend("<i class='fas fa-chevron-up'></i>");
						$('#chungbukDef').text(chungbuktodayData-chungbukyesterDayData).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						$('#chungbukDef').text(chungbuktodayData-chungbukyesterDayData).toString().replace(
				...
				else if (data[i].gubun == '충남') {
					if (changeC == moment(today).format('YYYY-MM-DD')) {
						chungnamtodayData = data[i].incDec;
						$('#chungnamCount').text(data[i].incDec).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						chungnamyesterDayData = data[i].incDec;
					}
					
					if(chungnamtodayData-chungnamyesterDayData<0) {
						$('#chungnam').prepend("<i class='fas fa-chevron-down'></i>");
						$('#chungnamDef').text(Math.abs(chungnamtodayData-chungnamyesterDayData)).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");	
					}
					else if(chungnamtodayData-chungnamyesterDayData>0) {
						$('#chungnam').prepend("<i class='fas fa-chevron-up'></i>");
						$('#chungnamDef').text(chungnamtodayData-chungnamyesterDayData).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						$('#chungnamDef').text(chungnamtodayData-chungnamyesterDayData).toString().replace(
				...
				else if (data[i].gubun == '전북') {
					if (changeC == moment(today).format('YYYY-MM-DD')) {
						jeonbuktodayData = data[i].incDec;
						$('#jeonbukCount').text(data[i].incDec).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						jeonbukyesterDayData = data[i].incDec;
					}
					
					if(jeonbuktodayData-jeonbukyesterDayData<0) {
						$('#jeonbuk').prepend("<i class='fas fa-chevron-down'></i>");
						$('#jeonbukDef').text(Math.abs(jeonbuktodayData-jeonbukyesterDayData)).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");	
					}
					else if(jeonbuktodayData-jeonbukyesterDayData>0) {
						$('#jeonbuk').prepend("<i class='fas fa-chevron-up'></i>");
						$('#jeonbukDef').text(jeonbuktodayData-jeonbukyesterDayData).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						$('#jeonbukDef').text(jeonbuktodayData-jeonbukyesterDayData).toString().replace(
				...
				else if (data[i].gubun == '전남') {
					if (changeC == moment(today).format('YYYY-MM-DD')) {
						jeonnamtodayData = data[i].incDec;
						$('#jeonnamCount').text(data[i].incDec).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						jeonnamyesterDayData = data[i].incDec;
					}
					
					if(jeonnamtodayData-jeonnamyesterDayData<0) {
						$('#jeonnam').prepend("<i class='fas fa-chevron-down'></i>");
						$('#jeonnamDef').text(Math.abs(jeonnamtodayData-jeonnamyesterDayData)).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");	
					}
					else if(jeonnamtodayData-jeonnamyesterDayData>0) {
						$('#jeonnam').prepend("<i class='fas fa-chevron-up'></i>");
						$('#jeonnamDef').text(jeonnamtodayData-jeonnamyesterDayData).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						$('#jeonnamDef').text(jeonnamtodayData-jeonnamyesterDayData).toString().replace(
				...
				else if (data[i].gubun == '경북') {
					if (changeC == moment(today).format('YYYY-MM-DD')) {
						gyeongbuktodayData = data[i].incDec;
						$('#gyeongbukCount').text(data[i].incDec).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						gyeongbukyesterDayData = data[i].incDec;
					}
					
					if(gyeongbuktodayData-gyeongbukyesterDayData<0) {
						$('#gyeongbuk').prepend("<i class='fas fa-chevron-down'></i>");
						$('#gyeongbukDef').text(Math.abs(gyeongbuktodayData-gyeongbukyesterDayData)).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");	
					}
					else if(gyeongbuktodayData-gyeongbukyesterDayData>0) {
						$('#gyeongbuk').prepend("<i class='fas fa-chevron-up'></i>");
						$('#gyeongbukDef').text(gyeongbuktodayData-gyeongbukyesterDayData).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						$('#gyeongbukDef').text(gyeongbuktodayData-gyeongbukyesterDayData).toString().replace(
				...
				else if (data[i].gubun == '경남') {
					if (changeC == moment(today).format('YYYY-MM-DD')) {
						gyeongnamtodayData = data[i].incDec;
						$('#gyeongnamCount').text(data[i].incDec).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						gyeongnamyesterDayData = data[i].incDec;
					}
					
					if(gyeongnamtodayData-gyeongnamyesterDayData<0) {
						$('#gyeongnam').prepend("<i class='fas fa-chevron-down'></i>");
						$('#gyeongnamDef').text(Math.abs(gyeongnamtodayData-gyeongnamyesterDayData)).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");	
					}
					else if(gyeongnamtodayData-gyeongnamyesterDayData>0) {
						$('#gyeongnam').prepend("<i class='fas fa-chevron-up'></i>");
						$('#gyeongnamDef').text(gyeongnamtodayData-gyeongnamyesterDayData).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						$('#gyeongnamDef').text(gyeongnamtodayData-gyeongnamyesterDayData).toString().replace(
				...
				else if (data[i].gubun == '제주') {
					if (changeC == moment(today).format('YYYY-MM-DD')) {

						$('#jejuCount').text(data[i].incDec).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
						jejutodayData = data[i].incDec;
					}
					else {
						jejuyesterDayData = data[i].incDec;
					}
					
					if(jejutodayData-jejuyesterDayData<0) {
						$('#jeju').prepend("<i class='fas fa-chevron-down'></i>");
						$('#jejuDef').text(Math.abs(jejutodayData-jejuyesterDayData)).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");	
					}
					else if(jejutodayData-jejuyesterDayData>0) {
						$('#jeju').prepend("<i class='fas fa-chevron-up'></i>");
						$('#jejuDef').text(jejutodayData-jejuyesterDayData).toString().replace(
								/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",");
					}
					else {
						$('#jejuDef').text(jejutodayData-jejuyesterDayData).toString().replace(
